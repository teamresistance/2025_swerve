...
public class ElevatorLowestCommandGroup extends SequentialCommandGroup {
  /** Creates a new ElevatorLowestCommandGroup. */
  public ElevatorLowestCommandGroup(ElevatorSubsystem subsystem) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
      new ElevatorLowerFirstStageCommand(subsystem),
