            ...
            () -> {
              ...
              ChassisSpeeds speeds =
                  new ChassisSpeeds(
                      ...
                      0.0 // No angular velocity, we're just moving in XY
                      );
  ...
  public static Command goTo2DPos(
    ...
    return Commands.run(
            () -> {
              ...
              double currentTagSize = tagData[2];
              double currentAngle = drive.getRotation().getRadians();

              // Compute PID outputs
              double xSpeed = pidX.calculate(currentX, targetX);
              double ySpeed = pidY.calculate(currentTagSize, targetTagSize);
